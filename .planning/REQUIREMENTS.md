...
- [x] **SCHEMA-03**: The existing `book.authors` text column is preserved as a denormalized display cache so the KOReader plugin's `/api/plugin/*` bulk-sync contract is unchanged
